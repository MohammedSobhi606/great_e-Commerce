...
import { addToCart, setCartCount } from "../Store/States";

import axios from "axios";
import { toast } from "react-toastify";
function Product() {
  const { products, baseurl, token } = useSelector((state) => state.states);
  ...
  const addToCartDB = async ({ productId, size, quantity }) => {
    try {
